                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdanthemuathich, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response.trim().equals("success")){
                            CheckConnection.ShowToast_Short(DoAnActivity.this,"Thêm thành công");

                        }else {
                            CheckConnection.ShowToast_Short(DoAnActivity.this,"lỗi");
                        }
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        CheckConnection.ShowToast_Short(DoAnActivity.this,"Lỗi server");
                    }
                }){
                    @Override
                    protected Map<String, String> getParams() throws AuthFailureError {
